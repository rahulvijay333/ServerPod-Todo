...
import 'package:todo_server/src/generated/greeting.dart' as _i5;
...
class _TodoEndpoint {
  ...
  _i3.Future<_i4.Todo> createTodo(
  ...
  _i3.Future<List<_i4.Todo>> getAllTodo(
  ...
  _i3.Future<_i4.Todo> updateTodo(
    _i1.TestSessionBuilder sessionBuilder,
    _i4.Todo todo,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
